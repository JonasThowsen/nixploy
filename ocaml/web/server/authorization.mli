...
val of_values :
  test_only:string option -> mode:string option -> operator_email:string option -> t Or_error.t
...
val authenticated_identity : t -> Cohttp.Header.t -> authenticated_identity Or_error.t
