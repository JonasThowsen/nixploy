...
(** Bounded values and exact wire messages for the target-lease tracer. The
    broker owns authorization and durable state; these values deliberately
    contain no paths, usernames, timestamps, or commands. *)
...
val parse_response_line : string -> response Or_error.t
