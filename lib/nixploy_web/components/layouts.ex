defmodule NixployWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="navbar border-b border-base-300 px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a href="/" class="flex w-fit items-center gap-3 font-semibold">
          <span class="flex size-9 items-center justify-center rounded-lg bg-primary font-mono text-primary-content">
            N
          </span>
          <span>nixploy</span>
        </a>
